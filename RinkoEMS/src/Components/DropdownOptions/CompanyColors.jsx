...
const CompanyColors = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance.get('/company_colors_options')
      .then(response => {
  ...
  const handleAddOption = () => {
    if (newOption.trim()) {
      axiosInstance.post('/company_colors_options', { name: newOption })
        .then(response => {
  ...
  const handleSaveEdit = () => {
    axiosInstance.put(`/company_colors_options/${editOption.id}`, { name: editOption.name })
      .then(response => {
  ...
  const handleDeleteOption = (id) => {
    axiosInstance.delete(`/company_colors_options/${id}`)
      .then(() => {
