...
const StatusOptions = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance.get('/status_options')
      .then(response => {
  ...
  const handleAddOption = () => {
    if (newOption.trim()) {
      axiosInstance.post('/status_options', { name: newOption })
        .then(response => {
  ...
  const handleSaveEdit = () => {
    axiosInstance.put(`/status_options/${editOption.id}`, { name: editOption.name })
      .then(response => {
  ...
  const handleDeleteOption = (id) => {
    axiosInstance.delete(`/status_options/${id}`)
      .then(() => {
